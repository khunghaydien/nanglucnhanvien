                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <div class="flex center-height">
                                                    ...
                                                    <a class="chuden  size-14">Nguyễn Trần Trung Quân
                                                    </a>
                                                </div>
                                            </td>
...
$(".js_khoiphuc").click(function() {
    $(".text_before_change").html(
        '<p> Bạn có chắc chắn muốn khôi phục đề kiểm tra</p><p class="top-5 font-medium">Đề kiểm tra nhân viên 1!</p>'
        );
    $(".h4_change").text('Khôi phục đề kiểm tra đã xóa');
    $(".btnhuy_before").click(function() {
        $(".change_text_tb").html(
            '<p> Khôi phục đề kiểm tra  <span class="font-medium">Đề kiểm tra nhân viên 1</span></p><p class="top-5">thất bại!!</p>'
            );
    });
    $(".btnluu_before").click(function() {
        $(".change_text_tc").html(
            '<p> Khôi phục đề kiểm tra  <span class="font-medium">Đề kiểm tra nhân viên 1</span></p><p class="top-5">thành công!</p>'
            );
    });
});
$(".js_xoavv").click(function() {
    $(".text_before_change").html(
        '<p> Bạn có chắc chắn muốn xóa đề kiểm tra</p><p class="top-5 font-medium">Đề kiểm tra nhân viên 1!</p>'
        );
    $(".h4_change").text('Xóa vĩnh viễn đề kiểm tra');
    $(".btnhuy_before").click(function() {
        $(".change_text_tb").html(
            '<p> Xóa đề kiểm tra  <span class="font-medium">Đề kiểm tra nhân viên 1</span></p><p class="top-5">thất bại!!</p>'
            );
    });
    $(".btnluu_before").click(function() {
        $(".change_text_tc").html(
            '<p> Xóa đề kiểm tra  <span class="font-medium">Đề kiểm tra nhân viên 1</span></p><p class="top-5">thành công!</p>'
            );
    });
});
$(".tongso_khoiphuc").click(function() {
    $(".h4_change").text('Khôi phục đề kiểm tra đã xóa');
    $(".text_before_change").html(
        '<p> Bạn có chắc chắn muốn khôi phục <span class="font-medium">4</span> đề kiểm tra đã chọn</p>');
    $(".btnhuy_before").click(function() {
        $(".change_text_tb").html(
            '<p> Khôi phục <span class="font-medium">4</span> đề kiểm tra đã chọn thất bại!</p>');
    });
    $(".btnluu_before").click(function() {
        $(".change_text_tc").html(
            '<p> Khôi phục <span class="font-medium">4</span> đề kiểm tra đã chọn thành công!</p>');
    });
});
$(".tongso_xoavv").click(function() {
    $(".h4_change").text('Xóa vĩnh viễn đề kiểm tra');
    $(".text_before_change").html(
        '<p> Bạn có chắc chắn muốn xóa <span class="font-medium">4</span> đề kiểm tra đã chọn</p>');
    $(".btnhuy_before").click(function() {
        $(".change_text_tb").html(
            '<p>Xóa <span class="font-medium">4</span> đề kiểm tra đã chọn thất bại!</p>');
    });
    $(".btnluu_before").click(function() {
        $(".change_text_tc").html(
            '<p>Xóa <span class="font-medium">4</span> đề kiểm tra đã chọn thành công!</p>');
    });
});
</script>