                            ...
                            <div class="flex">
                                <div class="khoi2">
                                    ...
                                    <div class="khoibutton_form top-25">
                                        <div onclick="hienpopupid('popup_before')" class="btn   btn-nentrang-chuxanh br-5 vienxanh font-medium size-15 c-pointer js_xoa_hoanthanh">
                                             Xóa 
                                        </div>
                                        <div  class="btn  btn-nenxanh-chutrang br-5 vienxanh font-medium size-15 c-pointer js_hoanthanh_hoanthanh">
                                            Lưu
                                        </div>
                                        
                                        <div onclick="hienpopupid('popup_before')" class="btn js_hoanthanh_hoanthanh btn-nenxanhluc-chutrang br-5 vienxanhluc font-medium size-15 c-pointer">
                                            Hoàn thành
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(".js_xoa_hoanthanh").click(function(){
        $(".text_before_change").html('<p> Bạn có chắc chắn xóa phiếu đánh giá <span class="top-5 font-medium">PDG0000?</span>');
        $(".h4_change").text('Xóa phiếu đánh giá');
        $(".btnhuy_before").click(function(){
        $(".change_text_tb").html('Xóa phiếu đánh giá <span class="font-medium">PDG0000</span> thất bại!');
        });
        $(".btnluu_before").click(function(){
            $(".change_text_tc").html('Xóa phiếu đánh giá <span class="font-medium">PDG0000</span> thành công!');
        });
    });
    $(".js_hoanthanh_hoanthanh").click(function(){
        $(".text_before_change").html('<p> Bạn có chắc chắn hoàn thành phiếu đánh giá <span class="top-5 font-medium">PDG0000?</span>');
        $(".h4_change").text('Xác nhận hoàn thành phiếu đánh giá');
        $(".btnhuy_before").click(function(){
        $(".change_text_tb").html('Xác nhận hoàn thành phiếu đánh giá <span class="font-medium">PDG0000</span> thất bại!');
        });
        $(".btnluu_before").click(function(){
            $(".change_text_tc").html('Xác nhận hoàn thành phiếu đánh giá <span class="font-medium">PDG0000</span> thành công!');
        });
    });
</script>