                    ...
                    <div class="lotrinhthangtien_chitiet">
                        <div class="m_lotrinh_chitiet">
                            <div class="flex nenxanh-chutrang space br-t-10 tieude_phongban">
                                ...
                                <div class="flex center-height c-pointer js_themchucvu" onclick="hienpopupid('popup_show_suachucvu')">
                                     <img src="../img/manhimg/themchucvu.png" class="flex center-height" alt="them chuc vu">
                                    ...
                                    <div class="chitiet_phongban flex space">
                                        ...
                                        <div class="c-pointer js_menu_curd">
                                            ...
                                            <div class="show_menu_curd nentrang">
                                                <div class="nd_con_menu_curd flex center-height br-t-10 js_thanhvien c-pointer">
                                                    <img src="../img/manhimg/xemds.png" class="flex center-height right-10" alt="xem danh sach">
                                                    <p class="chuden size-14">Xem danh sách thành viên</p>
                                                </div>
                                                <div class="nd_con_menu_curd flex center-height" onclick="hienpopupid('popup_show_suachucvu')">
                                                    <img src="../img/manhimg/chinhsua.png" class="flex center-height right-10" alt="chinh sua">
                                                    <p class="chuden size-14">Chỉnh sửa</p>
                                                </div>
                                                <div class="nd_con_menu_curd flex center-height" onclick="hienpopupid('popup_show_themyccv')">
                                                    <img src="../img/manhimg/them.png" class="flex center-height right-10" alt="chinh sua">
                                                    <p class="chuden size-14">Thêm yêu cầu công việc</p>
                                                </div>
                                                <div class="nd_con_menu_curd flex center-height br-b-10 js_xoachucvu" onclick="hienpopupid('popup_before')">
                                                    <img src="../img/manhimg/xoamn.png" class="flex center-height right-10" alt="chinh sua">
                                ...
                                <div class=" flex m_chitiet_phongban">
                                    <div class="chitiet_phongban">
                                        <div>
                                            ...
                                            <p class="chuden size-14 lineheight16">Mô tả công việc hoặc JD là một tường thuật bằng văn bản mô tả các nhiệm vụ chung hoặc các nhiệm vụ liên quan khác và trách nhiệm của một vị trí.</p>
                                        </div>
                                        <div class="flex just-end c-pointer js_menu_curd2">
                                            ...
                                            <div class="show_menu_curd2 nentrang ">
                                                <div class="nd_con_menu_curd br-t-10 flex center-height sua_yccv" onclick="hienpopupid('popup_show_themyccv')">
                                                    <img src="../img/manhimg/chinhsua.png" class="flex center-height right-10" alt="chinh sua">
                                                    <p class="chuden size-14">Chỉnh sửa yêu cầu công việc</p>
                                                </div>
                                                <div class="nd_con_menu_curd flex center-height br-b-10 js_xoa_yc" onclick="hienpopupid('popup_before')">
                                                    <img src="../img/manhimg/xoamn.png" class="flex center-height right-10" alt="chinh sua">
                                    ...
                                    <div class="nentrang">
                                        <div class="padding-20">
                                            ...
                                            <div class="khoibutton_form top-25">
                                                <div class="btn close btn-nentrang-chuxanh br-5 vienxanh font-medium size-15 c-pointer btnhuy_yeucau "onclick="hienpopupid('popup_thatbai')">
                                                    Hủy
                                                </div>
                                                <div class="btn close btn-nenxanh-chutrang br-5 vienxanh font-medium size-15 c-pointer btnluu_yeucau"onclick="hienpopupid('popup_thanhcong')">
                                                    Lưu
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="nentrang br-b-10">
                                        <div class="padding-20">
                                            ...
                                            <div class="khoibutton_form top-25">
                                                    ...
                                                    <div onclick="hienpopupid('popup_thanhcong')" class="btn close btn-nenxanh-chutrang br-5 vienxanh font-medium size-15 c-pointer btnluu">
                                                        Lưu
                                                    </div>
                                                </div>
                                        </div>
...
<script type="text/javascript">
    ...
    $(".js_xoa_yc").click(function(){
        ...
        $(".text_before_change").html('Bạn có chắc chắn muốn xóa yêu cầu công việc <p class="font-medium">Yêu cầu 1?</p> ');
    ...
    $(".js_themchucvu").click(function(){
        ...
        $(".btnhuy").click(function(){
        $(".change_text_tb").html('Thêm mới vị trí công việc <span class="font-medium">Nhân viên</span><p>thất bại!</p>');
        });
        $(".btnluu").click(function(){
            $(".change_text_tc").html('Thêm mới vị trí công việc <span class="font-medium">Nhân viên</span><p>thành công!</p>');
        });
    });
